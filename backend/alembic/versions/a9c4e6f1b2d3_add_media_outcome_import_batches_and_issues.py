...
def upgrade() -> None:
    if not _table_exists("media_outcome_import_batches"):
        op.create_table(
    ...
    _create_index_if_missing("ix_media_outcome_import_batches_id", "media_outcome_import_batches", ["id"])
    _create_index_if_missing("ix_media_outcome_import_batches_batch_id", "media_outcome_import_batches", ["batch_id"])
    _create_index_if_missing("ix_media_outcome_import_batches_brand", "media_outcome_import_batches", ["brand"])
    _create_index_if_missing("ix_media_outcome_import_batches_source_label", "media_outcome_import_batches", ["source_label"])
    _create_index_if_missing("ix_media_outcome_import_batches_status", "media_outcome_import_batches", ["status"])
    _create_index_if_missing("ix_media_outcome_import_batches_week_min", "media_outcome_import_batches", ["week_min"])
    _create_index_if_missing("ix_media_outcome_import_batches_week_max", "media_outcome_import_batches", ["week_max"])
    _create_index_if_missing("ix_media_outcome_import_batches_uploaded_at", "media_outcome_import_batches", ["uploaded_at"])
    _create_index_if_missing("ix_media_outcome_import_batches_created_at", "media_outcome_import_batches", ["created_at"])
    _create_index_if_missing("ix_media_outcome_import_batches_updated_at", "media_outcome_import_batches", ["updated_at"])
    _create_index_if_missing("idx_media_outcome_batch_brand_uploaded", "media_outcome_import_batches", ["brand", "uploaded_at"])
    _create_index_if_missing("idx_media_outcome_batch_status_uploaded", "media_outcome_import_batches", ["status", "uploaded_at"])

    if not _table_exists("media_outcome_import_issues"):
        op.create_table(
    ...
    _create_index_if_missing("ix_media_outcome_import_issues_id", "media_outcome_import_issues", ["id"])
    _create_index_if_missing("ix_media_outcome_import_issues_batch_id", "media_outcome_import_issues", ["batch_id"])
    _create_index_if_missing("ix_media_outcome_import_issues_row_number", "media_outcome_import_issues", ["row_number"])
    _create_index_if_missing("ix_media_outcome_import_issues_field_name", "media_outcome_import_issues", ["field_name"])
    _create_index_if_missing("ix_media_outcome_import_issues_issue_code", "media_outcome_import_issues", ["issue_code"])
    _create_index_if_missing("ix_media_outcome_import_issues_created_at", "media_outcome_import_issues", ["created_at"])
    _create_index_if_missing("idx_media_outcome_issue_batch_row", "media_outcome_import_issues", ["batch_id", "row_number"])
    _create_index_if_missing("idx_media_outcome_issue_batch_code", "media_outcome_import_issues", ["batch_id", "issue_code"])
