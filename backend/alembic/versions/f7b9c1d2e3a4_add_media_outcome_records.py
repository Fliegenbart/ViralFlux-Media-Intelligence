...
def upgrade() -> None:
    ...
    op.create_index('ix_media_outcome_records_id', 'media_outcome_records', ['id'])
    op.create_index('ix_media_outcome_records_week_start', 'media_outcome_records', ['week_start'])
    op.create_index('ix_media_outcome_records_brand', 'media_outcome_records', ['brand'])
    op.create_index('ix_media_outcome_records_product', 'media_outcome_records', ['product'])
    op.create_index('ix_media_outcome_records_region_code', 'media_outcome_records', ['region_code'])
    op.create_index('ix_media_outcome_records_source_label', 'media_outcome_records', ['source_label'])
    op.create_index('ix_media_outcome_records_import_batch_id', 'media_outcome_records', ['import_batch_id'])
    op.create_index('ix_media_outcome_records_created_at', 'media_outcome_records', ['created_at'])
    op.create_index('ix_media_outcome_records_updated_at', 'media_outcome_records', ['updated_at'])
    op.create_index('idx_media_outcome_brand_week', 'media_outcome_records', ['brand', 'week_start'])
    op.create_index('idx_media_outcome_product_week', 'media_outcome_records', ['product', 'week_start'])
