...
class Settings(BaseSettings):
    ...
    VIRUS_WAVE_TRUTH_ENABLED: bool = True
    VIRUS_WAVE_TRUTH_RUNTIME_MODE: bool = True
    VIRUS_WAVE_TRUTH_MATERIALIZED_MODE: bool = False
    VIRUS_WAVE_TRUTH_ALLOW_RUNTIME_FALLBACK: bool = True
