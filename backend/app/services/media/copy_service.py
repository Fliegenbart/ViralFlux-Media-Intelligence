...
PUBLIC_SOURCE_LABELS: dict[str, str] = {
    ...
    "BFARM_SUPPLY_GAP": "BfArM Engpassmonitor",
...
PUBLIC_EVENT_LABELS: dict[str, str] = {
    # Supply-gap (BfArM) signals: boost availability messaging during constrained supply.
    "MARKET_SUPPLY_GAP_GELO_PRO": "Lieferengpass im Markt: Erkältungsmittel",
    "MARKET_SUPPLY_GAP_GELO_GMF": "Lieferengpass im Markt: Husten und Bronchitis",
    "MARKET_SUPPLY_GAP_GELO_RVC": "Lieferengpass im Markt: Halsschmerz",
    "MARKET_SUPPLY_GAP_GELO_BRO": "Lieferengpass im Markt: Hustenstiller",
    "MARKET_SUPPLY_GAP_GELO_SIT": "Lieferengpass im Markt: Sinusitis",
    "MARKET_SUPPLY_GAP_GELO_DUR": "Lieferengpass im Markt: Schnupfen",
    "MARKET_SUPPLY_GAP_GELO_VOX": "Lieferengpass im Markt: Heiserkeit",
    "MARKET_SUPPLY_GAP_GELO_VIT": "Lieferengpass im Markt: Immunpräparate",
    "MARKET_SUPPLY_GAP_GELO_MUC": "Lieferengpass im Markt: Schleimlöser",
    # Legacy aliases (pre-ethics refactor)
    "COMPETITOR_SHORTAGE_GELO_PRO": "Lieferengpass im Markt: Erkältungsmittel",
    "COMPETITOR_SHORTAGE_GELO_GMF": "Lieferengpass im Markt: Husten und Bronchitis",
    "COMPETITOR_SHORTAGE_GELO_RVC": "Lieferengpass im Markt: Halsschmerz",
    "COMPETITOR_SHORTAGE_GELO_BRO": "Lieferengpass im Markt: Hustenstiller",
    "COMPETITOR_SHORTAGE_GELO_SIT": "Lieferengpass im Markt: Sinusitis",
    "COMPETITOR_SHORTAGE_GELO_DUR": "Lieferengpass im Markt: Schnupfen",
    "COMPETITOR_SHORTAGE_GELO_VOX": "Lieferengpass im Markt: Heiserkeit",
    "COMPETITOR_SHORTAGE_GELO_VIT": "Lieferengpass im Markt: Immunpräparate",
    "COMPETITOR_SHORTAGE_GELO_MUC": "Lieferengpass im Markt: Schleimlöser",
