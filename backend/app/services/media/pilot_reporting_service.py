...
from app.services.media import pilot_reporting_outcomes
...
class PilotReportingService:
    ...
    def _build_scope_comparison(
        ...
        *,
        ...
        return pilot_reporting_outcomes.build_scope_comparison(
            self,
            brand=brand,
            card=card,
            scope=scope,
    ...
    def _metric_summary(
        ...
        *,
        ...
        return pilot_reporting_outcomes.metric_summary(
            self,
            brand=brand,
            product=product,
    ...
    def _observation_within_window(
        *,
        ...
        return pilot_reporting_outcomes.observation_within_window(
    ...
    def _empty_metric_summary() -> dict[str, Any]:
        return pilot_reporting_outcomes.empty_metric_summary()

    @staticmethod
    def _primary_metric(before_metrics: dict[str, Any], after_metrics: dict[str, Any]) -> str | None:
        return pilot_reporting_outcomes.primary_metric(before_metrics, after_metrics)
    ...
    def _outcome_support_status(
        *,
        ...
        return pilot_reporting_outcomes.outcome_support_status(
            delta_pct=delta_pct,
    ...
    def _region_bucket() -> dict[str, Any]:
        return pilot_reporting_outcomes.region_bucket()
    ...
    def _accumulate_region_bucket(
        ...
        *,
        ...
        pilot_reporting_outcomes.accumulate_region_bucket(
            bucket,
            card=card,
    ...
    def _region_evidence_view(self, buckets: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
        return pilot_reporting_outcomes.region_evidence_view(buckets)

    def _pilot_kpi_summary(self, comparisons: list[dict[str, Any]]) -> dict[str, Any]:
        return pilot_reporting_outcomes.pilot_kpi_summary(comparisons)
