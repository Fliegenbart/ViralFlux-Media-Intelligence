...
class RankingSignalService:
    """Ranking Signal v2.0 auf Basis bestehender Modelle."""

    RANKING_SIGNAL_CONFIG = DEFAULT_RANKING_SIGNAL_CONFIG
    PEIX_CONFIG = DEFAULT_RANKING_SIGNAL_CONFIG
    ...
    def _load_translated_lab_policy_weights(self) -> None:
        ...
        # 4D (LabConfiguration) → 6D (Ranking Signal) Mapping.
        #
        # Die LabConfiguration liefert 4 Gewichte: bio, market, psycho, context.
        # Der Ranking-Signal-Score benötigt 6 Dimensionen. Das folgende Mapping ist eine
        ...
        logger.info(
            f"RankingSignal: Abgeleitete Policy-Gewichte aus LabConfiguration geladen "
    ...
    def _ranking_signal_metadata(*, score_field: str, legacy_field: str, label: str) -> dict[str, Any]:
        return {
            ...
            "field_contracts": {
                score_field: ranking_signal_contract(source="RankingSignal", label=label),
    ...
    def build(self, virus_typ: str = "Influenza A") -> dict[str, Any]:
        """Berechne das Ranking Signal für alle Regionen."""
        config = getattr(self, "PEIX_CONFIG", DEFAULT_RANKING_SIGNAL_CONFIG)
        ...
        for code, region_name in region_code_to_name.items():
            ...
            regions[code] = {
                ...
                "signal_band": risk_band,
                "signal_impact_probability": impact_probability,
                "score_0_100": score,
                "risk_band": risk_band,
                "impact_probability": impact_probability,
                "signal_drivers": top_drivers,
        ...
        return {
            "ranking_signal_score": national_score,
            "signal_band": self._score_to_band(national_score),
            "signal_impact_probability": round(self._score_to_probability(national_score), 1),
