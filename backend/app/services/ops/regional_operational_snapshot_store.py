    ...
    def build_scope_metadata(
        ...
        *,
        ...
        metadata = {
            ...
            "calibration_mode": forecast.get("calibration_mode"),
            "metric_semantics_version": forecast.get("metric_semantics_version"),
            "event_definition_version": forecast.get("event_definition_version"),
            "science_contract_version": forecast.get("science_contract_version"),
            "quantile_grid_version": forecast.get("quantile_grid_version"),
            "forecast_quantiles": forecast.get("forecast_quantiles") or [],
