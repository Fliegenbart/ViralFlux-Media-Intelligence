    ...
    map: {
      ...
      regions: {
        ...
        BY: {
          ...
          forecast_direction: 'aufwaerts',
          priority_explanation: 'Bayern bleibt als nächster prüfbarer Bundeslandpfad sichtbar.',
      ...
      activation_suggestions: [
        ...
        },
        {
          ...
          reason: 'Bayern kann als nächster regionaler Vorschlag vorbereitet werden.',
        },
        {
          region: 'NW',
...
function buildWorkspaceStatus(): WorkspaceStatusSummary {
  return {
    ...
    blocker_count: 0,
    blockers: [],
    summary: 'Die regionale Empfehlung ist klar genug für den nächsten prüffähigen Schritt.',
    items: [
      {
        key: 'forecast_status',
